...
простой и лаконичный язык Ruby для того, чтобы их работа стала более приятной и
продуктивной, а жизнь более веселой и беззаботной.

Наслаждайтесь работой с Ruby :)

## Назначение

*AssLauncher* это библиотека предоставляющая базовый набор абстракций делающих
работу с платформой 1С из языка Ruby более удобной, а создаваемые с
использованием *AssLauncher* инструменты более переносимыми с одной системы на
другую.
...
бинарным файлам платформы, и не только её.
