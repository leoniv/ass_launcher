...
Для этого в *AssLauncher* реализован специальный
...
версий платформы. Это очень нудное и трудное занятие которое можно
автоматизировать. На пример можно сохранить текст справки по CLI одной версии
...
Тема как использовать DSL достаточно обширная и здесь описана не будет, однако,
для примера, можно посмотреть уже существующие файлы в каталоге `cli_def`.
